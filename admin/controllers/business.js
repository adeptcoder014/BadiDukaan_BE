...
exports.createBusiness = async (req, res) => {
  try {
    ...
    const existingBusiness = await businessTypeModel.findOne({ name, type });
    // console.log(existingBusiness,);
    ...
    // Create new Business
    const newBusiness = new businessTypeModel({
      name,
      type, // e.g., Manufacturer, Retailer, etc.
      description,
...
exports.getBusiness = async (req, res) => {
  try {
    ...
    const businesses = await businessTypeModel.find(filter);
